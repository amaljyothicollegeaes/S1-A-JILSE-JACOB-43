...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if($mail != "")
    {
        $query = "insert into login (fname,lname,password,email,phone) values ('$fname','$lname','$password','$mail',$phone)";
...
<body>
    <div class="loginbox">
        ...
        <h1>REGISTER</h1>
         ...
         <p>Phone:<input type="tel" id="phone" name="phone" placeholder="eg:-8080808080"  value="" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" required/></p><center>
